...
class Pogom(Flask):
    def __init__(self, import_name, **kwargs):
        ...
        self.route("/raw_dataleo", methods=['GET'])(self.raw_data)
    ...
    def raw_data(self):
        d = {}
        swLat = request.args.get('swLat1')
        swLng = request.args.get('swLng2')
        neLat = request.args.get('neLat3')
        neLng = request.args.get('neLng4')
